...
if __name__ == "__main__":
    ...
    (bwa_tool,RGRP,bwa_ref,end1,samtools_tool,samtools_ref,sample,log_dir,threads)=(inputs.bwa_tool,inputs.RGRP,inputs.bwa_ref,inputs.end1,inputs.samtools_tool,inputs.samtools_ref,inputs.sample,inputs.log_dir,inputs.threads)
    bwa_mem_se(bwa_tool,RGRP,bwa_ref,end1,samtools_tool,samtools_ref,sample,log_dir,threads)
